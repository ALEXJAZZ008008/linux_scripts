...
then
  ...
  for i in gcc g++ make  cmake-curses-gui libncurses-dev libx11-dev libboost-dev libpng++-dev libpng-dev libpng-tools libpng16-16 tcsh python swig python-dev python-numpy ipython python-matplotlib mayavi2 mpi-default-dev mpi-default-bin libinsighttoolkit4-dev libtiff5-dev libvtkgdcm-cil libvtkgdcm-java libvtkgdcm-tools libvtkgdcm2-dev libvtkgdcm2.8 python-vtkgdcm libgdcm-cil libgdcm-java libgdcm-tools libgdcm2-dev libgdcm2.8 libboost-numpy-dev libboost-numpy1.65-dev libboost-numpy1.65.1 numpy-stl python-numpy python-numpy-dbg python-numpy-doc python-numpydoc python3-numpy python3-numpy-dbg python3-numpydoc graphviz graphviz-doc libghc-graphviz-dev libghc-graphviz-doc libghc-graphviz-prof libgraph-writer-graphviz-perl libgraphviz-dev libgraphviz-perl python-pygraphviz python-pygraphviz-dbg python-pygraphviz-doc python3-graphviz python3-pygraphviz python3-pygraphviz-dbg ruby-graphviz trac-graphviz
  do
    apt install -y $i
  done
  ...
  for i in gcc g++ make  cmake-curses-gui libncurses-dev libx11-dev libboost-dev libpng++-dev libpng-dev libpng-tools libpng16-16 tcsh python swig python-dev python-numpy ipython python-matplotlib mayavi2 mpi-default-dev mpi-default-bin libinsighttoolkit4-dev libtiff5-dev libvtkgdcm-cil libvtkgdcm-java libvtkgdcm-tools libvtkgdcm2-dev libvtkgdcm2.8 python-vtkgdcm libgdcm-cil libgdcm-java libgdcm-tools libgdcm2-dev libgdcm2.8libboost-numpy-dev libboost-numpy1.65-dev libboost-numpy1.65.1 numpy-stl python-numpy python-numpy-dbg python-numpy-doc python-numpydoc python3-numpy python3-numpy-dbg python3-numpydoc graphviz graphviz-doc libghc-graphviz-dev libghc-graphviz-doc libghc-graphviz-prof libgraph-writer-graphviz-perl libgraphviz-dev libgraphviz-perl python-pygraphviz python-pygraphviz-dbg python-pygraphviz-doc python3-graphviz python3-pygraphviz python3-pygraphviz-dbg ruby-graphviz trac-graphviz
  do
    apt purge -y $i
  done
